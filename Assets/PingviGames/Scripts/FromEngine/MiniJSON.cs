...
*/
    ...
    protected static object parseNumber(char[] json, ref int index)
    {
        ...
        try
        { 
           return Int32.Parse(new string(numberCharArray));
        }
        catch 
        {
        ...
        try
        {
            return Int64.Parse(new string(numberCharArray));
        }
        catch
        {
        ...
        try
        {
            return UInt64.Parse(new string(numberCharArray));
        }
        catch
        {
...
//          Debug.Log("type: " + t.ToString() + " isArray: " + t.IsArray + " " + value.ToString());
        ...
        {
            serializeArray(new List<object>( (ICollection<object>)value), builder);
        }
